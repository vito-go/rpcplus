...
// NewServerCodec returns a new [rpcplus.ServerCodec] using JSON-RPC on conn.
...
func (c *serverCodec) WriteResponse(r *rpcplus.Response, x any) error {
	c.mutex.Lock()
